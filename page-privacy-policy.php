<?php get_header();?>
<main id="main" class="under-page page-privacy-policy">
    <div class="lux-margin">
        <div class="container">
            <div class="head">
                <h2>プライバシーポリシー</h2>
                <p>
                    2階のクラフトビール屋つむぎ（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、
            ...
            <div class="box">
                ...
                <p>
                    ...
                    連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
                </p>
            </div>
            <div class="box">
                <h3>第2条（個人情報の収集方法）</h3>
            ...
            <div class="box">
                ...
                <p>
                    住所：千葉県柏市南柏1-2-6 南柏ビル207<br>
                    社名：2階のクラフトビール屋 つむぎ<br>
                    代表取締役：大江信明<br>
                    Eメールアドレス：tsumugi.craftbeer.minamikashiwa@gmail.com
                </p>
            </div>
        </div>
    </div>
